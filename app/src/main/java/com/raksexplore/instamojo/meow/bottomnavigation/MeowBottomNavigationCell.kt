...
package com.raksexplore.instamojo.meow.bottomnavigation
...
import com.raksexplore.instamojo.databinding.MeowNavigationCellBinding
...
class MeowBottomNavigationCell @JvmOverloads constructor(
    ...
    private var iconSize = 45f.dp(context)
        set(value) {
            field = value
            if (allowDraw) {
