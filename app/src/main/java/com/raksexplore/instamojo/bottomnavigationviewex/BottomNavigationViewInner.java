package com.raksexplore.instamojo.bottomnavigationviewex;
...
//        mMenuView.updateMenuView();
        setLabelVisibilityMode(enable ? NavigationBarView.LABEL_VISIBILITY_AUTO : NavigationBarView.LABEL_VISIBILITY_AUTO);
        return this;
    }
